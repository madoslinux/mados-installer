...
TRANSLATIONS = {
    "Italiano": {
        ...
        "btrfs_scheme_title": "Btrfs con Snapshots (Consigliato per OTA)",
        "btrfs_scheme_desc": "Abilita aggiornamenti atomici con rollback automatico. Tutti i dati in una partizione con subvolumi.",
        "btrfs_subvolumes_title": "Subvolumi Btrfs:",
        "bootable": "avviabile",
        "efi_label": "EFI",
        ...
        "secure_boot_note": "Se Secure Boot è abilitato, al primo avvio potrebbe aprirsi MokManager per registrare la chiave di madOS. Usa la password salvata in <b>/root/mok-password.txt</b> nel sistema installato.",
